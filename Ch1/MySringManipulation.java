/**
 *  Program Name: MySringManipulation.java
 *   Description: This program demonstrates how to manipulate a 
 *                String using its different methods.
 * Related class: String 
 *         Input: Single String.
 *          args: N/A
 *        Output: Different variations of the same String by using the String methods.
